...
john = User()
# print(john.register('john3', 'dsjlkafjasl;df'))
# print(john.login('john', 'hakjsdf4'))
# print(john.change_password('john', 'hakjsdf4', 'klafjsfjl1'))
print(john.change_name('john', 'sam'))